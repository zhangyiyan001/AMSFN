...
class MultiVMamba(nn.Module):
    def __init__(
        ...
        self.in_proj = nn.Linear(self.d_model, self.d_inner * 2, bias=bias, **factory_kwargs) # d_model = 81, d_inner=162
    ...
    def forward(self, hidden_states, inference_params=None):
        ...
        Returns: same shape as hidden_states
        """
        batch_size, seq_len, dim = hidden_states.shape # [B, L, D] [32, 144, 81]
        xz = self.in_proj(hidden_states) #
