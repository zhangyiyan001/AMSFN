...
# x1 = torch.randn(32, 144, 9, 9).cuda()
# model = VSSBlock(hidden_dim=144, ssm_d_state=16, ssm_ratio=2.0,
#                  ssm_dt_rank="auto", ssm_act_layer=nn.SiLU, ssm_conv=3,
#                  ssm_conv_bias=True, ssm_drop_rate=0.0, ssm_simple_init=False,
#                  directions=None).cuda()
# out = model(x1)
# print(out.shape)
